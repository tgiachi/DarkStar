...
namespace DarkSun.Engine.MessageListeners
{
    ...
    {
        public PongMessageListener(ILogger<BaseNetworkMessageListener<PongMessageResponse>> logger, IDarkSunEngine engine) : base(logger, engine)
        {

        }

        public override Task OnMessageReceivedAsync(Guid sessionId, DarkSunMessageType messageType, PongMessageResponse message)
        {
