...
public partial class RenderControl : UserControl
{
    ...
    class CustomDrawOp : ICustomDrawOperation
    {
        ...
        public static readonly Stopwatch _renderStopwatch = Stopwatch.StartNew();
        ...
        public void Render(IDrawingContextImpl context)
        {
            ...
            else
            {
                ...
                canvas.Save();
                RenderAction?.Invoke((canvas!, _renderStopwatch.Elapsed));
        ...
        // {
        //     var ms = (int)(_renderStopwatch.ElapsedMilliseconds / d);
        //     var diff = to - from;
        //     var range = diff * 2;
        //     var v = ms % range;
        //     if (v > diff)
