...
{
    [ProtoMember(1)] public List<PlayerObjectMessage> Players { get; set; } = null!;

    public PlayerListResponseMessage()
    {
    }

    public PlayerListResponseMessage(List<PlayerObjectMessage> players) => Players = players;
}
...
public class PlayerObjectMessage
{
    ...
    [ProtoMember(3)] public uint Tile { get; set; }
    [ProtoMember(4)] public int Level { get; set; }
    [ProtoMember(5)] public string Race { get; set; } = null!;
}
